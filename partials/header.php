  ...
  <body>
    <header>
      <ul>
        ...
        <li style="float:right"><a href="#about">Registro</a></li>
        <li style="float:right"><a href="#about"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-basket2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
