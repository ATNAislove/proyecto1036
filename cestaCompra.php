  ...
  <table id = "compra">
      ...
      foreach($tareas as $k => $tarea){
        if (0 < strlen($tarea)){
          ...
          <td>";   echo "    <a href="; echo $link; echo"  id='borrar' class='button' ><svg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-trash-fill' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
